    ...
    <table class="table table-centered table-nowrap mb-0">
        <thead class="table-light">
            <tr>
                ...
                <th>Status da Compania</th>
                <th>Origem do Capital</th>
                <th>Relação com Grupo</th>
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($resultado)) {
                ...
                <tr>
                    ...
                    <td>
                        <h5><span class="badge badge-success-lighten"><i class="mdi mdi-bitcoin"></i> <?php echo $row['organization_type']; ?></span></h5>
                    </td>
                    <td>
                        <?php echo $row['company_status']; ?>
                    </td>
                    <td>
                    <h5><span class="badge badge-info-lighten"><?php echo $row['capital_origin']; ?></span></h5>
                    </td>
                    <td>
                        <h5><span class="badge badge-info-lighten"><?php echo $row['relationship_group']; ?></span></h5>
                    </td>
                    <td>
